...
# Luis Delgado Sepulveda's CV

This repository contains **my professional data**, stored as a [MAC](/CV/MAC.json) (or Manfred Awesomic CV), an open-source, interchangeable, machine-readable format. It's also synchronized with [my profile in Manfred](https://getmanfred.com/profile/luisd).
<br/>
<br/>

<div align='center'>
  <img src='https://img.shields.io/static/v1?label=CV%20Last%20Sync&message=2022-09-02 21:33 UTC&color=brightgreen&style=for-the-badge'>
